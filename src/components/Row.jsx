...
const Row = ({title, fetchUrl, RowID}) => {
  ...
  return (
    ...
    <div className="relative flex items-center group ">
        <MdChevronLeft  onClick={slideLeft}   className='bg-primary rounded-full text-white opacity-50 hover:opacity-100 relative z-10
         cursor-pointer group-hover:block' size={30}/>
        <div id={'slider'+ RowID}
    ...
    <MdChevronRight onClick={slideRight} className='bg-primary rounded-full text-white  opacity-50 hover:opacity-100 relative z-10
     cursor-pointer group-hover:block'  size={30}/>
