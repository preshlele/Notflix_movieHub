...
const NowPlaying = () => {
  ...
  useEffect(() => {
    const Api= `https://api.themoviedb.org/3/movie/now_playing?api_key=9db476c7ff7210e3afa19a2a536f7af7&language=en-US&page=${pageNumber}`
  ...
  return (
    ...
    <div className='w-full h-full'>
      <p className='p-4 text-3xl font-semibold'>Now Playing </p>
      {movies.map((item,id)=>(
